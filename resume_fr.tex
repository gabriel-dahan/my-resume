...
2025--présent & \textbf{Diplôme d'ingénieur}, ENSAI, Rennes \\
& \vspace{-0.2cm}
  \begin{itemize}[leftmargin=0.4cm, itemsep=1pt, topsep=0pt]
    \item Accrédité par la Commission des Titres d'Ingénieur (CTI). Diplôme d'ingénieur en statistiques et sciences des données.
  \end{itemize} \\

2025--présent & \textbf{Licence de Mathématiques}, Université de Rennes I, Rennes \\
& \vspace{-0.2cm}
  \begin{itemize}[leftmargin=0.4cm, itemsep=1pt, topsep=0pt]
