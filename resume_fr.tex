...
\begin{itemize}[leftmargin=0.4cm, itemsep=1pt]
    \item \textbf{IT \& Programmation :} Python (NumPy, pandas, scikit-learn, Matplotlib, Flask, SQLAlchemy, psycopg2), Javascript (NodeJS, Express, Typescript, VueJS), HTML/CSS, OCaml, Git.
